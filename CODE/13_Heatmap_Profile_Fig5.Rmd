...
To include set information column indicating which row in heatmap came from which set
```{r,message=FALSE,warning=FALSE,results="hide"}
...
pheatmaps.obj<-pheatmap(profile2, cluster_cols = FALSE,cellheight = 11,cellwidth = 11,fontsize = 12,gaps_col = c(3,6,9,12,15,18,21,24,27,30,33,36,39,42,45,48,51,54,57,60,63,66,69,72,75,78,81,84,87,90,93,96,99,102,105,108,111,114,117,120,123), annotation_row=annotation_profile, filename = "Heatmap.pdf")
```
