...
#Input Notes:
#This is the forth step of this pipeline is designed to be used after completing 2_Virome_Assembly.sh
  # You can preform this step either before or after the third step:  3. Virome Contig Mapping (3_Virome_Contig_Mapping.sh)
...
#Will result in a kraken_output.txt file that will be used inconjunction with the output files of kaiju, demovir, and independent blast searches
...
#Will result in both kaiju_virus_names.tsv and kaiju_DB_names.tsv files that will be used inconjunction with the output files of demovir, kraken2, and independent blast searches
...
#Will result in a demovir_assignments.txt file that will be used inconjunction with the output files of kaiju, kraken2, and independent blast searches
