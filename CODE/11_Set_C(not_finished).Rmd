...
RH_Markers2 <- RH_Stable2$Species
RH_Markers2
```
#SC
```{r}
...
Hand_Markers_Shared2
All_Markers_Shared2 <- Hand_Markers_Shared2[Hand_Markers_Shared2 %in% SC_Markers2]
```
