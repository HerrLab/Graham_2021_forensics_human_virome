...
##############################################
## ---------------------------------------- ##
## -Determine Stable Families by Location - ##
## ---------------------------------------- ##
##############################################
...
OTU_SUMS -> OTU_Stable 
# Turn into binary presence/absance data
...
```
```{r}
# Left Hand Stable Family Markers: 
LH_Markers
```
...
```
```{r}
# Right Hand Stable Family Markers: 
RH_Markers
```
...
```
```{r}
# Stable Across All Locations Family Markers: 
